  ...
  return (
    <>
      ...
      <div className={styles.gridContainer}>
        <DocBlock name="Rigol DG2000 Arbitrary Waveform Generator" pageID="Rigol-DG2000" documentName="Rigol-DG2000" />
        <DocBlock name="FPGA" pageID="FPGA" documentName="FPGA" />
        <DocBlock name="Guitar" pageID="Guitar" />
        <DocBlock name="McDonalds Ice Cream Machine" pageID="McDonalds" documentName="McDonalds" />
        <DocBlock name="LG Washing Machine" pageID="Washing" documentName="Washing" />
        <DocBlock name="Oscilloscope" pageID="Oscilloscope" documentName="Oscilloscope" />
        <DocBlock name="Atmega328P" pageID="Atmega" documentName="Atmega" />
      </div>
